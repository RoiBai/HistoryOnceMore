...
const endingChronicles = {
  "history-jieting": {
    date: "蜀汉建兴六年春",
    kind: "史实纪要",
    record: [
      "亮出祁山，使马谡督诸军守街亭，王平副之。谡至，不依节度，舍水上山。平连谏不纳，魏将张郃因绝其汲道，蜀军饥渴震扰，遂大溃。平独鸣鼓整众，郃疑有伏，不敢迫，故得收诸营散卒而还。",
      "街亭既失，亮知陇右之势不可复支，乃拔西县千余家退还汉中。谡以违令伏诛，平以收军有功进位。亮上疏自劾，请贬三等。初出祁山之势，至是而中止。"
    ],
    appraisal: "史臣曰：临阵之失，常起于一念自是；全军之存，亦可系于一人不乱。用人者任其才，尤当察其所短。"
  },
  "steady-throat": {
    date: "蜀汉建兴六年春",
    kind: "反事实推演",
    record: [
      "亮既命谡守街亭，别授王平节制汲道之权，申令大营不得离水。谡欲移军登高，平执令止之，中军快骑亦至，遂罢其议，列营当道，沟垒相属。",
      "郃军至，见蜀营有水有援，数挑战而谡不出。相持数日，魏军不能越街亭。亮得以整顿陇右诸郡，虽未能一举定关中，而粮道不绝，北伐亦未仓促而还。"
    ],
    appraisal: "史臣曰：奇谋可以求胜，守令所以保败。使一军不以主将好恶移其根本，则庸策亦能久，妙策未必先行。"
  },
  "late-correction": {
    date: "蜀汉建兴六年春",
    kind: "反事实推演",
    record: [
      "谡既移营山上，平驰书告急。亮得报，立遣使者严令下山。诏至之日，魏骑已窥汲道，蜀军仓卒移辎，前后相失。平据水列阵，接应山上诸营，始免全军俱溃。",
      "街亭虽未尽失，士卒死伤甚众，北伐锐气由是而衰。亮还军后，定前军复命之法，凡营地、水道、退路皆须绘图日上，不得但以‘无事’二字塞责。"
    ],
    appraisal: "史臣曰：善令不在辞严，而在能及事前。救败之令虽当，迟一日，则所救者已非昨日之军。"
  },
  "masu-saves-face-late": {
    date: "蜀汉建兴六年春",
    kind: "反事实推演",
    record: [
      "谡初欲凭高拒魏，及见汲道将断，乃召诸校曰：‘计出于我，误亦在我。’遂撤山上辎重，使平先据水口，自领后队拒追。军中虽乱，尚得全其大半。",
      "战后，亮以谡能改令而免其死，然违节度之罪不可废，夺其兵任，使留府中参画。平以持营有功受赏。诸将由是知临阵认过可以救众，却不能抹去先前之失。"
    ],
    appraisal: "史臣曰：人患不知过，尤患知过而爱其名。能舍一己之名以全众，虽不足称胜，犹胜于抱误俱亡。"
  },
  "wangping-covers": {
    date: "蜀汉建兴六年春",
    kind: "史实延展",
    record: [
      "谡军既败，诸营争道而走。平所领千余人独鸣鼓自持，整旗徐退。郃望其部伍不乱，疑山谷间别有伏兵，止骑不追。平因收合散卒，护辎重而归。",
      "街亭终为魏有，亮不得不退军。然败兵有归队之处，沿途不至尽为追骑所乘。论功之日，众将多被削黜，平独以败中能整众而进位。"
    ],
    appraisal: "史臣曰：胜负既分之后，能使败者不溃，亦将才也。世人喜言转败为胜，而军国所需，往往先是有人肯收拾残局。"
  },
  "hard-retreat": {
    date: "蜀汉建兴六年春",
    kind: "反事实推演",
    record: [
      "谡固守山上，不肯回军。平见魏骑渐合，恐一军尽没，乃不待主将之命，分兵据水，复遣队接引山营。由是救出士卒数千，而主副号令自此分裂。",
      "还汉中后，平自诣军门请罪。亮以其救军有功，不可尽罚；以其擅改军令，亦不可尽赏。遂记功而夺任，并定急变之条：主将失令、全军将溃时，副将得先救军，事后听勘。"
    ],
    appraisal: "史臣曰：法所以齐众，非所以助误。然人人皆可自称救急，则军亦不军。权变与擅命之间，只能以事实、时刻与本令逐项核之。"
  },
  "wei-historical-win": {
    date: "魏太和二年春",
    kind: "史实纪要",
    record: [
      "郃奉诏驰救陇右，至街亭，见谡营于山而舍其水道。郃不仰攻其坚，先使轻骑断汲路。蜀军数日不得水，营中自乱，郃乃纵兵击之，谡众遂散。",
      "及王平鸣鼓整阵，郃疑其设伏，止诸军勿追，先据街亭要路。亮闻前军败，退还汉中；魏军因得复定陇右。郃以一战挫蜀军之锋，名益重。"
    ],
    appraisal: "史臣曰：名将之胜，不必攻人所恃，惟取其不可久者。既胜而知止，故战果不为贪功所损。"
  },
  "wei-overreach": {
    date: "魏太和二年春",
    kind: "反事实推演",
    record: [
      "郃既破谡，诸将请乘胜尽歼王平。郃初从之，追骑并入狭道。平据险鸣鼓，弩手迭射，魏军前后壅塞，追势顿挫。",
      "郃乃收兵，街亭虽得，蜀军残部却多从容退去。亮因多得半日，收束诸军与陇右百姓而还。魏军有胜名，而未能尽收骤破前锋之利。"
    ],
    appraisal: "史臣曰：知敌之败易，知敌败中尚有可用之力难。贪多一阵，常足以少得一局。"
  },
  "wei-envelopment": {
    date: "魏太和二年春",
    kind: "反事实推演",
    record: [
      "郃见蜀军上山，恐其另有伏援，不即断水，先分兵合围。魏军阵势周密，伤亡甚少；蜀军亦因半日之缓，暗遣轻装诸营从后坡撤走。",
      "及魏军进据山营，所获多为辎重空帐。街亭仍归于魏，而亮中军已整队西退。诸将称其稳，郃独言谨慎若失其时，亦与迟疑无异。"
    ],
    appraisal: "史臣曰：持重者贵在不失机，果决者贵在不轻进。二者若各守其名而不察其时，皆非善战。"
  },
  ...
  "sarhu-history": {
    ...
    kind: "史实纪要",
    record: [
      "经略杨镐会诸将于辽阳，分大军为四路，期会赫图阿拉。杜松先出抚顺，渡浑河而进；马林、刘綎、李如柏各由异道趋敌境，道路阻远，军报旬日不相及。",
      "努尔哈赤闻明军分进，尽合八旗之众，先破杜松于萨尔浒，旋移兵击马林，又诱刘綎深入而歼之。李如柏闻败引还。明军数路先后覆没，朝鲜援军亦死降相继，辽东攻守之势由此大变。"
    ],
    appraisal: "史臣曰：四路俱进，纸上足以张敌四面；号令不通，则四路皆为孤军。兵多而不能相见，犹少也。"
  },
  "sarhu-coordinated": {
    date: "明万历四十七年春",
    kind: "反事实推演",
    record: [
      "镐察山川险远，改四路齐趋之令，使杜松、马林相去不逾一日，刘綎未得北路实报不得深入。诸军行期因此迟缓，京师奏疏交责畏敌。",
      "后金数次诱杜松先行，松终以接应未至而驻营。努尔哈赤不能专兵围其一部，遂退守内线。明军未克赫图阿拉，亦未有数万之丧，得以撤回边墙重议攻守。"
    ],
    appraisal: "史臣曰：合兵不是众旗同画于一图，乃是危急之时真能相救。宁失虚名之速，不可失实在之援。"
  },
  "sarhu-delayed-retreat": {
    date: "明万历四十七年春",
    kind: "反事实推演",
    record: [
      "北路败讯既至，诸军所闻参差。刘綎以五日不见友军旗号，止营复探；李如柏亦据险不进。中军虽屡催军期，二将终未深入重围。",
      "杜松、马林既折，明军大势仍去，然南、西两路多得保全。班师之后，言官交章论其迟误，经略与诸将各执一词。朝廷不得不先补辽东空营，再议军法。"
    ],
    appraisal: "史臣曰：败局中退一步，未必得名，往往能留下明日守边之兵。军法若只问到期与否，而不问军报何时到手，亦非明断。"
  },
  "sarhu-du-song-fall": {
    date: "明万历四十七年春",
    kind: "史实延展",
    record: [
      "杜松素以敢战闻，至浑河，不待后军尽集，先渡而进。后金小队且战且退，松逐之深入，前锋遂与马林隔绝。",
      "努尔哈赤合诸旗围击，明军临山阻水，火器与骑阵不能相救。松力战死，所部大溃。前锋一折，原定四路会师之约先失其一，余军闻报皆震。"
    ],
    appraisal: "史臣曰：先锋之勇，所以开路；若勇至不顾后援，则所开者未必是胜路，也可能是敌人为他留下的入口。"
  },
  "sarhu-liu-ting-ambush": {
    date: "明万历四十七年春",
    kind: "史实延展",
    record: [
      "刘綎由宽甸远道入山，军中杂有朝鲜兵，驿路稀少。杜松败后，消息未能及时传至南路；后金又以所得符信诱其速进。綎信疑相半，终以军期迫近而前。",
      "努尔哈赤遣兵前后夹击，明军在山谷间不能成列。綎身被创，犹督亲兵力战，遂没于阵。朝鲜诸营失其依倚，或死或降，南路至是尽败。"
    ],
    appraisal: "史臣曰：老将能识百战之险，未必能补千里之外的消息断绝。军令失真，则忠于军期者反先入危地。"
  },
  "sarhu-jin-decisive": {
    date: "后金天命四年春",
    kind: "史实纪要",
    record: [
      "明军四道来攻，诸贝勒请分守诸路。努尔哈赤曰：‘凭尔几路来，我只一路去。’乃留轻骑侦候，尽合主力先趋萨尔浒。",
      "既破杜松，军不解甲，旋击马林；又断南路声息，诱刘綎深入而歼之。诸旗每战复合，未因俘获而久散。明军虽众，接战之处常不能以众临少，后金声势由此大振。"
    ],
    appraisal: "史臣曰：兵力之多寡，不独在册籍总数，更在一时一地能用几何。能使众敌轮番而至，即能以少为多。"
  },
  "sarhu-jin-overreach": {
    date: "后金天命四年春",
    kind: "反事实推演",
    record: [
      "后金既破杜松，各旗争逐败兵，部伍渐散。努尔哈赤恐马林收合残军反击，急令鸣金，以日落归营为限，军功按归队之数核录。",
      "诸将虽以未能尽歼为憾，主力终得复聚。明军部分残部因而退还，后金之胜不及史实彻底，却没有在胜后重蹈分兵之失。"
    ],
    appraisal: "史臣曰：始以集中得胜，终亦须以集中保胜。将能约束争功之众，方算真正拥有那支军队。"
  },
  ...
  "tongguan-history": {
    ...
    kind: "史实纪要",
    record: [
      "哥舒翰守潼关，知崔乾祐以羸兵诱敌，屡请坚壁。玄宗听杨国忠言，遣中使相继督战，使者项背相望。翰不得已，抚膺恸哭，引军出关。",
      "唐军至灵宝西原，南山北河，道路狭长。乾祐伏兵乘高下木石，复以草车纵火，烟焰蔽野。官军前后相蹂，死者甚众，潼关遂陷。玄宗闻败，仓卒西幸，长安震动。"
    ],
    appraisal: "史臣曰：将知其不可而不能止，君闻其可疑而不肯缓。潼关之败，非独一阵失机，实由猜防先败于朝堂。"
  },
  "tongguan-held": {
    date: "唐天宝十五载夏",
    kind: "反事实推演",
    record: [
      "玄宗复下出关之诏，翰伏地抗命，言关外必有伏兵，愿以逗留受死。王思礼等整军闭关，诸营不得越险求战。",
      "乾祐诱兵数次，唐军终不出。河北郭子仪、李光弼因得进军，叛军归路日迫。朝廷虽遣使按问哥舒翰，潼关仍在，长安亦未骤失屏障。"
    ],
    appraisal: "史臣曰：奉诏为臣节，保军亦为将责。二者相冲之时，敢以一身当罪而不以万众试疑，固非常人所能。"
  },
  "tongguan-northern-plan": {
    date: "唐天宝十五载夏",
    kind: "反事实推演",
    record: [
      "朝廷采郭子仪、李光弼之议，命潼关坚守，河北诸军乘胜北指范阳。哥舒翰日修关垒，不以收复陕、洛为近功；郭、李则连州进取，断燕军馈运与归路。",
      "安禄山闻范阳危急，洛阳军心渐摇，不得不分兵东顾。关中因而无大战，战局之重由潼关城下移向河北。唐军未即复两京，却先使叛军首尾不能相救。"
    ],
    appraisal: "史臣曰：兵争不必尽在眼前。能守住敌所必过之门，再攻其所不能不救之地，虽缓于一城之复，或捷于全局。"
  },
  "tongguan-delay": {
    date: "唐天宝十五载夏",
    kind: "反事实推演",
    record: [
      "杨国忠遣人核视关外，始知所谓燕军数千多出传闻。玄宗暂止催战，使灞上军不得妄动，潼关诸军仍归一令。",
      "月余之间，关门无警，河北战报屡至。然国忠疑边帅兵重，哥舒翰疑朝廷夺军，嫌隙未尽。出关之议虽缓，统帅与宰相之间的旧结仍待再决。"
    ],
    appraisal: "史臣曰：止一误令易，复君臣之信难。军国之患，往往不在无人说真话，而在真话须先穿过彼此的疑心。"
  },
  "tongguan-command-change": {
    date: "唐天宝十五载夏",
    kind: "反事实推演",
    record: [
      "哥舒翰病且受疑，乃上表解兵柄，不率众西归，惟请新帅未至之前仍闭关勿出。玄宗许之，以王思礼暂摄军务，别议可代者。",
      "关中因此免于仓促一战，军中却因节度更易而人心不安。新帅若不谙山河，仍可能复议出兵；若久无定命，二十万新募之卒亦难久制。"
    ],
    appraisal: "史臣曰：交出兵权可以自明，不能替国家生出一位合宜的继任者。制度能止猜疑于一时，成败仍系于交接是否有序。"
  },
  "tongguan-bloody-retreat": {
    date: "唐天宝十五载六月",
    kind: "反事实推演",
    record: [
      "唐军既入灵宝，见烟火起于前阵。哥舒翰知中伏，急令后军止进，王思礼分精兵据南山，护诸部次第东还。前军死伤甚众，后队未尽陷于狭道。",
      "燕军追至关外，唐军已复闭潼关。翰点集残卒，不先问罪，昼夜修守。长安闻败大震，然关门尚在，朝廷仍有整军与迁民之暇。"
    ],
    appraisal: "史臣曰：败不可讳，退亦有法。能使后军听见退令，使败卒尚知归处，便是在大败中替国家留下时间。"
  },
  "tongguan-fracture": {
    date: "唐天宝十五载夏",
    kind: "反事实推演",
    record: [
      "王思礼劝哥舒翰劾杨国忠，翰从之。奏疏既入，国忠亦言翰拥兵跋扈，灞上与潼关两军各为戒备。玄宗恐内变先于外寇，命二人俱停职待问。",
      "潼关暂以部将守之，出关之令因而中止。然朝廷临敌易相，军中不知所从，京师百官亦分为两议。关虽未失，政令已经先裂。"
    ],
    appraisal: "史臣曰：除一人未必能除一国之疑。君若不能明授其权、明任其责，则换将易相，不过把旧惧换一个名字。"
  },
  "tongguan-yan-victory": {
    date: "燕圣武元年六月",
    kind: "史实纪要",
    record: [
      "崔乾祐屯陕郡，外示羸卒数千，散漫无备；精兵则伏于灵宝险处。及唐军出关，乾祐列弱兵于前，接战即退，引其大队尽入西原。",
      "伏发，山上木石并下，草车纵火，烟尘塞路。唐军前后不能相救，争渡黄河，死伤不可胜计。乾祐乘胜取潼关，燕军西入，长安门户洞开。"
    ],
    appraisal: "史臣曰：伏兵之妙，不只藏兵，更在使敌方朝堂先相信眼前之弱。诏书把唐军推出关门，燕军才有一战破关之机。"
  },
  "tongguan-yan-overreach": {
    date: "燕圣武元年六月",
    kind: "反事实推演",
    record: [
      "乾祐伏击既胜，诸部争俘逐北，各循山道而进。唐军后队尚未尽乱，王思礼收兵扼守数处窄路，使追骑不能并至。",
      "燕军虽据灵宝战场，却未能尾随败兵夺门。及诸将复受节制，潼关已闭。乾祐只得留兵围守，主力分还洛阳，野战之胜未即化为关中之得。"
    ],
    appraisal: "史臣曰：设伏时能令万人候一旗，取胜后却各逐一功，则胜势亦会自行分散。破军与夺关，本是两件事。"
  }
};
...
function renderEnding() {
  ...
  const chronicle = endingChronicles[state.endingId];
  setBackground("court");
  ...
  app.innerHTML = `
    <section class="ending-layout">
      <header class="ending-header">
        ...
        <h1>${ending.title}</h1>
        <p class="ending-summary">${ending.result}</p>
      </header>

      <article class="chronicle-scroll">
        <header class="chronicle-heading">
          <div>
            <span>${chronicle.date}</span>
            <strong>终卷纪事</strong>
          </div>
          <em>${chronicle.kind}</em>
        </header>
        <div class="chronicle-copy">
          ${chronicle.record.map((paragraph) => `<p>${paragraph}</p>`).join("")}
        </div>
        <blockquote class="historian-note">${chronicle.appraisal}</blockquote>
        <p class="chronicle-disclaimer">本文采用仿纪传体笔法写成；“反事实推演”并非史料原文，史实边界见下方参照。</p>
      </article>
